...
public class CustomersAddPage {
	...
	public CustomersAddPage(WebDriver driver) {
		this.driver=driver;
	...
	By btnPlus=							By.xpath("//i[@class='fa-plus toggle-icon fa']");
	...
	public void clickOnCustomersMenu() {
		waitHelper.WaitForElement(lnkCustomers_menu, 30);
		driver.findElement(lnkCustomers_menu).click();
	}

	public void clickOnCustomersMenuItem() {
		waitHelper.WaitForElement(lnkCustomers_menuitem, 30);
		driver.findElement(lnkCustomers_menuitem).click();
	}

	public void clickOnAddnew() {
		waitHelper.WaitForElement(btnAddnew, 30);
	...
	public void setPassword(String password){
		waitHelper.WaitForElement(txtPassword, 20);
		driver.findElement(txtPassword).sendKeys(password);
	}
	
	public void expandCustomerPage() {
		waitHelper.WaitForElement(btnPlus, 30);
		try {
			if(driver.findElement(btnPlus).isDisplayed()) {
	...
	public void setCustomerRoles(String role) throws InterruptedException {
		waitHelper.WaitForElement(txtcustomerRoles, 30);
	...
	public void setGender(String gender){
		waitHelper.WaitForElement(rdMaleGender, 20);
